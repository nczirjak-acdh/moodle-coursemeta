...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// this is important! DO NOT REMOVE the managemodules, because 
// it is allows to use externalpage without core file modifications
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
$controller->set_redirect($CFG->wwwroot.'/enrol/coursemeta/custominfo/index.php');
...
$popupurl = new moodle_url('/enrol/coursemeta/custominfo/index.php?id=0&action=editfield');
